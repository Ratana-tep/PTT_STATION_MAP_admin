...
fetch("../../admin/data/markers.json")
  .then((response) => response.json())
  .then((data) => {
    var stations = data.STATION;
    populateIconContainersAndDropdown(stations);

    fetch("../../admin//data/promotions.json")
      .then((response) => response.json())
      .then((promotionData) => {
        stations.forEach((station) => {
          ...
          // Create image URL
            var imageUrl = `../../admin/pictures/${station.picture}`;
...
function getPromotionImageUrl_MARKER(item) {
    const promotionImages = {
        "promotion 1": "../../admin/pictures/promotion/promotion_1.jpg",
        "promotion 2": "../../admin/pictures/promotion/promotion_2.jpg",
        "promotion 3": "../../admin/pictures/promotion/promotion_3.jpg",
        "promotion 4": "../../admin/pictures/promotion/promotion_4.jpg",
        "promotion opening 1": "../../admin/pictures/promotion/promotion_opening_1.jpg",
        "promotion opening 2": "../../admin/pictures/promotion/promotion_opening_2.jpg",
        "promotion opening 3": "../../admin/pictures/promotion/promotion_opening_3.jpg",
        "promotion opening 4": "../../admin/pictures/promotion/promotion_opening_4.jpg",
        // Add other promotions as needed
    };
    return (
        promotionImages[item] || "../../admin/pictures/promotion/default.png"
